...
char* basedir = "/home/ssd/StockInsider/text/replies_CSRC/";
char filename[128];
char* basecom = "java SingleTextIndexer -replies_CSRC ";
char command[256];

MYSQL conn;
MYSQL_RES* res;
MYSQL_ROW row;
char* SQL_select = "SELECT reply_id,link FROM replies_CSRC WHERE downloaded=0;";
char SQL_update[512];
char* SQL_update_prefix = "UPDATE replies_CSRC SET title='";
char* SQL_update_mid_fix = "',downloaded=1 WHERE reply_id='";
